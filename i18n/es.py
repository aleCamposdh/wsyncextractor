...
""",
    ...
    "qbo_connected": "✅ Conectado — **{company}**",
    "qbo_not_connected": "No conectado a QuickBooks",
    "btn_connect_qbo": "🔗 Conectar con QBO",
    "btn_disconnect_qbo": "Desconectar QBO",
    "btn_test_qbo": "🧪 Probar QBO",
    "qbo_connect_success": "✅ QBO conectado — **{company}**",
    "qbo_connect_error": "❌ Error QBO: {err}",
    "qbo_test_ok": "✅ QBO activo — {company}",
    "qbo_test_fail": "❌ QBO falló: {err}",
    "qbo_token_expired": "⚠️ Sesión QBO expirada. Vuelve a conectar.",
    # QBO Upload section
    "section_qbo_upload": "📒 Crear Facturas en QuickBooks",
    "qbo_upload_hint": "Sube el reporte de visitas de Jobber para crear las facturas automáticamente.",
    "qbo_upload_label": "Reporte de Visitas (CSV de Jobber)",
    "qbo_preview_title": "Vista previa — {n} facturas a crear",
    "btn_create_invoices": "📤 Crear facturas en QBO ({n})",
    "qbo_invoice_progress": "Procesando {i} de {n}: {title}",
    "qbo_invoice_complete": "✅ Facturas creadas.",
    "section_qbo_report": "📋 Reporte QBO",
    "qbo_col_title": "Visita",
    "qbo_col_customer": "Cliente",
    "qbo_col_amount": "Monto",
    "qbo_col_status": "Estado",
    "qbo_col_invoice": "# Factura",
    "qbo_col_error": "Error",
    "qbo_warning_not_connected": "⚠️ Conecta a QuickBooks para crear facturas.",
    # Sidebar
